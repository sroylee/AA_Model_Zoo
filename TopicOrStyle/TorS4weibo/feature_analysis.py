...
def main():
    ...
    parser.add_argument('--nb_class', type=int, default=50, help='number of class')
    ...
    parser.add_argument('--feature_dim', type=int, default=1379, help='feature dimension')
    ...
    if data == 'ccat10' or data == 'ccat50':
        ...
        print(x_train_rep.shape, x_val_rep.shape, x_test_rep.shape)
